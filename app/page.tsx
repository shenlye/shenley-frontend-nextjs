...
export default function Home() {
  ...
  return (
    <div
      ref={container}
      className="container mx-auto flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-4 overflow-hidden"
    >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="icon">
              <a
                ...
                rel="noopener noreferrer"
              >
                <Icon icon="mdi:email" className="w-6 h-6 hover:text-primary" />
              </a>
            </div>
            <div className="icon">
              <a
                ...
                rel="noopener noreferrer"
              >
                <Icon icon="mdi:telegram" className="w-6 h-6 hover:text-primary" />
              </a>
            </div>
          </div>
        </div>
